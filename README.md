...
My name is Fatima Al-Soqatri, and I am pursuing a Master's degree in Cyber Security. With a deep passion for technology and a keen interest in safeguarding digital systems, I have dedicated myself to understanding and combating the evolving threats in the realm of cybersecurity..

### What

In this e-portfolio, I have started from the very beginning.  I learned about HTML and CSS.  Then download the template from my University portal and started building my own e-Portfolio.

### When

I have been working on it for the last 1 month and finally, I would say it is 85% complete and I will keep on updating it based on improvements and skills.

### Where

I have used the Brackets tool to build this e-Porfolio using HTML5, CSS3, and Javascript.

### Why

This e-Portfolio helped to build my own carreer website where I have mentioned my all skills and courses with subjects taken in the university of Essex.

## Table of Contents
 * [HTML](https://github.com/Fatma-110/e-PorfolioMsc)
	* Editors
	* Tag Structure
	* Text Structure
	* Links
 ...
 * [CSS](https://github.com/Fatma-110/e-PorfolioMsc)
 ...
 * [Final Project!](https://github.com/Fatma-110/e-PorfolioMsc)
